...
backgroundIMG = pygame.image.load("assets/img.jpg")
...
pygame.mixer.music.load("assets/backgroundbgm.wav")
point = pygame.mixer.Sound("assets/pick.wav")
point.set_volume(0.3)
miss = pygame.mixer.Sound("assets/Zap.wav")
miss.set_volume(0.3)

############################################### FONTS ###########################################################

Font = pygame.font.Font("assets/lemon.otf", 70)
endFont = pygame.font.Font("assets/lemon.otf", 50)
welcomeFont = pygame.font.Font("assets/lemon.otf", 90)
startFont = pygame.font.Font("assets/lemon.otf", 45)
...
scoreRect.topright = (WINDOW_WIDTH - 30, 0)
